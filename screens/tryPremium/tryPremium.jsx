    ...
    return (
        <View style={premiumScreenStyles.mainContainer}>
            ...
            <View style={premiumScreenStyles.innerMiddle}>
                <TextComponent text={'Try Premium'} customStyling={premiumScreenStyles.tryPremiumText} />
                <View style={{ marginVertical: 20 }}>
                    {
                        premiumFeatures.map((feature, index) => {
                            return <View style={premiumScreenStyles.featureListContainer} key={index}>
                                <Image source={tick} />
                                <TextComponent text={feature} customStyling={premiumScreenStyles.featureListText} />
                            </View>
                        })
                    }
                </View>
                <View style={premiumScreenStyles.premiumPricingmain}>
                    ...
                    <View style={{ gap: 5 }}>
                        <TextComponent text={'Year/1200PKR'} customStyling={premiumScreenStyles.pricingText} />
                        <TextComponent text={'12 months at - 100PKR/month'} customStyling={[premiumScreenStyles.pricingText, { color: 'black' }]} />
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                            <View style={{ borderRadius: 10, width: 100, height: 30, backgroundColor: AppColors.mainBackgroundColor, justifyContent: 'center', alignItems: 'center' }}>
                                <TextComponent text={'Year/1200PKR'} customStyling={{ color: 'white', fontSize: 12 }} />
                            </View>
                            <TextComponent text={'Save 33%'} customStyling={[premiumScreenStyles.pricingText]} />
                        </View>
                    </View>
                </View>
                <CustomStyledButton
